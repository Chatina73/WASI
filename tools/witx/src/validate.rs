use crate::{
    ...
    parser::{
        DatatypeIdentSyntax, DeclSyntax, EnumSyntax, FlagsSyntax, HandleSyntax, ImportTypeSyntax,
    ...
    Definition, Entry, EnumDatatype, FlagsDatatype, HandleDatatype, Id, IntRepr, InterfaceFunc,
